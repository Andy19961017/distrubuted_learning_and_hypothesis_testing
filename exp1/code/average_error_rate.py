...
def plot_history(error1, r1, error2, r2, error3, r3):
	...
	l=('case1, rate:'+str(r1[0])[:4]+" "+str(r1[1])[:4], 'case2, rate:'+str(r2[0])[:4]+" "+str(r2[1])[:4], 'case3, rate:'+str(r3[0])[:4]+" "+str(r3[1])[:4])
	plt.legend(l)
	plt.grid(True)
...
if len(sys.argv) != 2:
	print("Usage: python3 average_error_rate.py iteration")
	sys.exit(0)
...
a11, a12, a21, a22 = 0.01, 0.3, 0.2, 0.6 
...
error1=error1/(2*num_of_trail)
error2=error2/(2*num_of_trail)
error3=error3/(2*num_of_trail)
